...
namespace Quiz.Controllers
{
    public class UyesController : Controller
    {
        ...
        public UyesController(QuizContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Ad,Soyad,Kayit_Tarihi,Yas")] Uye uye)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Ad,Soyad,Kayit_Tarihi,Yas")] Uye uye)
        {
            if (id != uye.ID)
            {
                return NotFound();
