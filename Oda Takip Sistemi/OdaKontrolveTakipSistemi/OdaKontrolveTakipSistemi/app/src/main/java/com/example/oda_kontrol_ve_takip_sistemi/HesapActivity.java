...
public class HesapActivity extends AppCompatActivity {
    ...
    public void hesap_olustur (View view){
        if (binding.mailTxtbox.getText().toString() != null && (binding.sifreTxtbox.getText().toString())==(binding.sifreTekrarTxtbox.getText().toString())) {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent intent=new Intent(HesapActivity.this, MainActivity.class);
